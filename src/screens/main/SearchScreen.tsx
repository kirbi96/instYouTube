          ...
          {[...Array(4)].map((_, index) => (
            <TouchableOpacity key={index}>
              <Image
                ...
                source={{
                  uri: 'https://img01.rl0.ru/afisha/e1200x600i/daily.afisha.ru/uploads/images/2/f2/2f23c421db983f28be0a4d9e84fe1d3d.png',
                }}
              />
            </TouchableOpacity>
          ))}
        ...
        {[...Array(6)].map((_, index) => (
          <TouchableOpacity key={index}>
            <Image
              style={styles.smallImage}
              source={{
                uri: 'https://sun9-11.userapi.com/impg/VhbLBeJkOJ1_iitkUn0mdVS59fNk8l1Uj38qUg/UVBcOVQkULU.jpg?size=640x640&quality=96&sign=097b61e3980a162149353467941ffc8b&type=album',
              }}
            />
          </TouchableOpacity>
        ))}
